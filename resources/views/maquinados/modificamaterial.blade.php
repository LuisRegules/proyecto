                        ...
                        @endif
                            ...
                            <div class="card-body">
                                <div class="card-title">
                                    <h3 class="text-center title-2">Modifica material</h3>
                                </div>
                                <form action =  "{{route('guardamodificamaterial')}}"  method = "POST" enctype='multipart/form-data' >   
                                {{csrf_field()}}
                                    ...
                                    @endif
                                        ...
                                        <input id="cc-pament" name="id_material" type="text" class="form-control"
                                            aria-required="true" aria-invalid="false" value="{{$material->id_material}}" readonly ='readonly'>
                                    </div>
                                    ...
                                    @endif
                                        <input id="cc-pament" name="nombre" type="text" class="form-control"
                                            aria-required="true" aria-invalid="false" value="{{$material->nombre}}">
                                    </div>

                                      <div class="form-group">
                                        
                                        @if($material->activo=='SI') 
