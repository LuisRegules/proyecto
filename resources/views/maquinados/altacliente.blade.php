                        ...
                        @endif
                            ...
                            <div class="card-body">
                                ...
                                {{csrf_field()}}
                                    ...
                                    @endif
                                    <!-- onkeyup="this.value=this.value.toUpperCase() "   esta cadena convierte de minusculas a mayusculas-->
                                    <!--pattern="^[a-z]{20}"  este campo hace que solo acepte letras y solo 20-->
                                    ...
                                    @endif
                                        <input id="cc-pament" name="empresa" type="text" class="form-control" placeholder="Inserta el la empresa"
